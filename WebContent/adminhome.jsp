    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="adminhome.jsp?page=view">View User KYCS</a></li>
          <li><a href="adminhome.jsp?page=viewf">View Financers</a></li>
           <li><a href="adminhome.jsp?page=viewK">View KYC requests</a></li>
